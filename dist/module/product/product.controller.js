...
__decorate([
    common_1.Post(),
    swagger_1.ApiOperation({ title: "Create Products" }),
...
__decorate([
    common_1.Get(),
    swagger_1.ApiOperation({ title: "List Products" }),
...
__decorate([
    ...
    swagger_1.ApiOperation({ title: "Delete Products" }),
    __param(0, common_1.Param()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [product_1.Product]),
...
CustomController = __decorate([
    ...
    __metadata("design:paramtypes", [product_service_1.Service])
], CustomController);
